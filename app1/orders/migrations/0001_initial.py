# Generated by Django 5.0.3 on 2024-04-07 20:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='В обробці', max_length=50, verbose_name='Статус замочлення')),
                ('user', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL, verbose_name='Користувачь')),
            ],
            options={
                'db_table': 'order',
            },
